...
<style>
    .profile-section {
        min-height: 80vh; /* Is se footer hamesha neche rahega */
        padding-top: 140px;
        padding-bottom: 60px;
    ...
    .profile-card {
        background: #fff;
        border-left: 5px solid #ce1212; /* Aapki theme ka red color */
    }
    .booking-card {
        background: #fff;
    }
...
<div class="profile-section">
    <div class="container">
        <div class="section-header text-center mb-5">
            <h2 style="font-family: 'Amatic SC', sans-serif; font-size: 50px;">Welcome Back, <span style="color: #ce1212;">{{ $user->name }}</span></h2>
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><i class="bi bi-people me-2 text-muted"></i>{{ $book->persons }} Persons</td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-4">
                                        <i class="bi bi-emoji-frown d-block mb-2" style="font-size: 30px; color: #ccc;"></i>
                                        No reservations found. <a href="{{ route('website') }}#book-a-table" class="text-danger">Book a table now?</a>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>

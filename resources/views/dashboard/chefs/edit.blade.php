                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded-pill @error('name') is-invalid @enderror" 
                                id="name" name="name" placeholder="Chef Name" value="{{ old('name', $chef->name) }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control rounded-pill @error('experience') is-invalid @enderror" 
                                id="experience" name="experience" placeholder="Experience" min="0" 
                                value="{{ old('experience', $chef->experience) }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded-pill @error('specialty') is-invalid @enderror" 
                                ...
                                value="{{ old('specialty', $chef->specialty) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-4 text-center">
                            <div class="image-upload-wrapper border rounded-circle mx-auto"
                                ...
                                @if ($chef->chef_picture)
                                    <img id="previewImage" src="{{ asset('Chefs/chefs_pictures/' . $chef->chef_picture) }}"
                                ...
                                @endif
                                <input type="file" class="d-none" id="chef_picture" name="chef_picture" accept="image/*"
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                ...
                                placeholder="Address" style="height: 100px;" required>{{ old('address', $chef->address) }}</textarea>
                        ...
                        <div class="form-floating mb-3">
                            <input type="tel" class="form-control rounded-pill @error('phone') is-invalid @enderror" 
                                id="phone" name="phone" placeholder="Phone" value="{{ old('phone', $chef->phone) }}" 
                                required>
                    ...
                    <div class="col-12 text-center">
                        <button type="submit" class="btn btn-lg rounded-pill px-5 border-0 btn-gradient"
                            style="
                                ...
                                padding: 12px 30px;
                            ">
                            <i class="bi bi-save me-2"></i> Update Chef
                        </button>
                    </div>
                </div>
            </form>

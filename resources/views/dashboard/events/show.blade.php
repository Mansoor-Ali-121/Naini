                    ...
                    <table class="table table-hover table-striped align-middle">
                        <thead class="bg-light-primary">
                            <tr>
                                ...
                                <th class="py-3" style="border-bottom: 2px solid #3498db;">Event Name</th>
                                <th class="py-3 text-center" style="border-bottom: 2px solid #3498db;">Price</th>
                                <th class="py-3 text-center" style="border-bottom: 2px solid #3498db;">Description</th>
                                <th class="py-3 text-center" style="border-bottom: 2px solid #3498db;">Image</th>
